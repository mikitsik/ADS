...
state_list.each do |status|
  17.times do |number|
  ad = Advertisement.create( user_id: 2, state: status, title: "Lorem Ipsum #{number + 1}",
  ...
  ad.images.attach(io: File.open("spec/images/beautiful-day.jpg"), filename: "beautiful-day.jpg", content_type: "image/jpeg")
  ad.images.attach(io: File.open("spec/images/northern-forest.jpg"), filename: "northern-forest.jpg", content_type: "image/jpeg")
  end
end

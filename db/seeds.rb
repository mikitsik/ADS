...
state_list.each do |status|
  ...
  ad.images.attach(io: File.open("spec/images/beautiful-day.jpg"), filename: "beautiful-day.jpg")
  ad.images.attach(io: File.open("spec/images/northern-forest.jpg"), filename: "northern-forest.jpg")
  end
end
